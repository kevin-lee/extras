...
object RenderSyntaxSpec extends Properties {
  ...
  override def tests: List[Test] = Specs(extras.render.syntax.render).tests ++ Specs(extras.render.syntax.all).tests

  final case class Specs(renderSyntax: RenderSyntax) {
